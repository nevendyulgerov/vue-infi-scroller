...
<td style="text-align:left;">Turn on/off the infinite scroller. Keeps the component's children visible. Destroys event listeners when set to <code>false</code>. Initializes event listeners when set to <code>true</code>. Useful when the infinite scroller is placed inside a modal and you want it disabled until the modal is activated.</td>
</tr>
<tr>
